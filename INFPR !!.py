...
def entry(strtrw,qty,remain):
    ...
    str1 = worksheet6.cell(8,2).value#############
    exception=[]
    a1=""
    for i in range (0,len(str1)):
        if str1[i]==",":
            exception.append(int(a1))
            a1=""
        elif i==len(str1)-1:
            exception.append(int(a1+str1[i]))
        else:
            a1+=str1[i]
...
str1 = worksheet5.cell(8,2).value
try:
...
excetions_under_limits = []
excetions_under_limits1 = []
for i in exception:
    if i>a:
        excetions_under_limits1.append(i)
qty=int(worksheet5.cell(3, 2).value)-11-len(excetions_under_limits1)

if qty>15:
    for i in range(a,qty,15):#################
        if(i+4)>qty:
            break
        print(start_row,i)
    ...
    if (qty)%15!=0:
        ...
        for i in exception:
            if i>a and i<work:
                excetions_under_limits.append(i)
        work = work+len(excetions_under_limits)+1
        print(start_row,work,(qty)%15,",,,")
        (start_row,work,notes_value)=entry(start_row,work,(qty)%15)
else:
    (start_row,work,notes_value)=entry(start_row,a,((qty)%15))
