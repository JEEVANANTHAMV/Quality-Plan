...
worksheet3.cell(1, 1).value = "PART NAME : " + str(worksheet.cell(5, 3).value)
worksheet3.cell(1, 4).value = worksheet.cell(6, 3).value
worksheet3.cell(1, 9).value = "Po No :" + str(worksheet1.cell(2, 2).value)
...
worksheet2.cell(35, 1).value = "PART NAME : " + str(worksheet.cell(5, 3).value)
worksheet2.cell(35, 4).value = worksheet.cell(6, 3).value
worksheet2.cell(35, 9).value = "Po No :" + str(worksheet1.cell(2, 2).value)
...
totalqty=int(worksheet1.cell(3,2).value)
if int(totalqty) <=10:
    qty=int(totalqty)
else:
    qty=10
        ...
        if parameters[i] =="Angle" or parameters[i]=="Chamfer Angle":
            if "°" in specifications[i]and "'" in specifications[i] :
                ...
                try:
                    ...
                    minimum_value.append(float(r)+tol_min_final[i])
                    maximum_value.append(float(r)+tol_max_final[i])
                except:
...
c=len(str(part))
if last_value < 36:
    for i in range(9,9+qty):
        worksheet2.cell(6,i).value=worksheet1.cell(7, 2).value
        worksheet2.cell(7,i).value=str(i-8).zfill(c)+a
        worksheet2.cell(7,i).alignment = Alignment(horizontal = "center",vertical="center")
        worksheet2.cell(6,i).alignment = Alignment(horizontal = "center",vertical="center")
if last_value<72 and last_value>36:
    for i in range(9,9+qty):
        worksheet2.cell(36,i).value=worksheet1.cell(7, 2).value
        worksheet2.cell(37,i).value=str(i-8).zfill(c)+a
        worksheet2.cell(37,i).alignment = Alignment(horizontal = "center",vertical="center")
        worksheet2.cell(36,i).alignment = Alignment(horizontal = "center",vertical="center")
        worksheet2.cell(6,i).value=worksheet1.cell(7, 2).value
        worksheet2.cell(7,i).value=str(i-8).zfill(c)+a
        worksheet2.cell(7,i).alignment = Alignment(horizontal = "center",vertical="center")
        worksheet2.cell(6,i).alignment = Alignment(horizontal = "center",vertical="center")
if last_value>72:
    ...
    for j in range(73,last_value,35):
        for i in range(9,9+qty):
            worksheet2.cell(j,i).value=worksheet1.cell(7, 2).value
            worksheet2.cell(j,i).alignment = Alignment(horizontal = "center",vertical="center")
            
            worksheet2.cell(j+1,i).value=str(i-8).zfill(c)+a #####need to add the any alphabet
            worksheet2.cell(j+1,i).alignment = Alignment(horizontal = "center",vertical="center")
...
for i in range(0,len(skip_1)):
    if(skip_1[i]<=last_value):
        ...
        if (a in skip_1 and a+1 in skip_1 and a+2 in skip_1):
            worksheet2.cell(a,1).value = "Inspected By : "
            worksheet2.cell(a,1).alignment = Alignment(horizontal = "left",vertical="center")
            worksheet2.cell(a,4).value = "Verified By: "
            worksheet2.cell(a,4).alignment = Alignment(horizontal = "left",vertical="center")
